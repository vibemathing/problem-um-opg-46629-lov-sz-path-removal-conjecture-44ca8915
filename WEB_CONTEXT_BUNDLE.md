...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-46629"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-v1",
      "problem_contract_sha256": "c1850f994e0f728237bd3e6b1aa47310614eed168ef531e3564e67e8309881ef",
      "problem_id": "problem:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915",
      "route_id": "route:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-source-fidelity-01",
      "graph_id": "graph:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture There is an integer-valued function $f(k)$ such that if $G$ is any $f(k)$-connected graph and $x$ and $y$ are any two vertices of $G$, then there exists an induced path $P$ with ends $x$ and $y$ such that $G-V(P)$ is $k$-connected."
          },
          "statement_sha256": "1d6c5397b09d44b40d6d5b9d950285cefa694a1369500e562f6a2cef6842d63f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-root",
      "route_id": "route:um-opg-46629-lov-sz-path-removal-conjecture-44ca8915-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-46629-5f7832cf18e0",
        "url": "https://www.unsolvedmath.com/problems/OPG-46629"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
